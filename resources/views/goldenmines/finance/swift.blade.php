        ...
        <div class="commission-block text-center">
            ...
            <div class="commission-block__btns">
                <div class="text-center">
                    ...
                    <a data-type="swift" data-amount="{{ $settings->swift1 }}" data-toggle="add-swift-1" class="alert-link modal-toggle user-block__cashin" href="#">
                        {{ __('To pay') }}
                    </a>
                    <small>
                ...
                <div class="text-center">
                    ...
                    <a data-type="swift" data-amount="{{ $settings->swift2 }}" data-toggle="add-swift-2" class="alert-link modal-toggle user-block__cashin" href="#">
                        {{ __('To pay') }}
                    </a>
                    <small>
