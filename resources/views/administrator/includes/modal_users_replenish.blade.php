...
<div class="modal-header">
	...
	<h4 class="modal-title">{{ trans('Replenish balance') }}</h4>
</div>
<form method="post" action="/administrator/user/balance_replenish" class="horizontal-form" id="balance_replenish">
