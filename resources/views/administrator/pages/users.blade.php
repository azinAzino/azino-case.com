...
<div class="">
	<button 
		...
		style="float:right;"
		href="/administrator/user/create">{{ trans('Create') }}</button>
					...
					<tbody>
						...
						<tr>
							...
							<td align="center" style="vertical-align: middle;">
								<button type="button" class="btn blue btn-sm" data-toggle="modal" data-target="#usr_edit" href="/administrator/user/{{ $user->id }}/edit">{{ trans('Edit') }}</button>
								<button type="button" class="btn green btn-sm" data-toggle="modal" data-target="#usr_replenish" href="/administrator/user/{{ $user->id }}/replenish">{{ trans('Replenish') }}</button>
								<button type="button" class="btn red btn-sm" data-toggle="modal" data-target="#usr_takeaway" href="/administrator/user/{{ $user->id }}/takeaway">{{ trans('Reduce') }}</button>
							</td>
						</tr>
						@endforeach
					</tbody>
