	...
	@foreach($a as $b)
			<div class="col-xs-12" style="background-color: #f3f3f3; border: 1px solid #aaa; margin-bottom: 20px;">
				...
				<div class="col-xs-3" style="margin-top: 20px;">
					...
					@if($b->ban == 0)
						<div class="col-xs-6" style="margin-bottom: 20px; text-align: center;">
							<a href="/administrator/user/{{ $b->user_id }}/ban" style="text-decoration:none;"><div class="btn-danger">Ban</div></a>
						</div>
					@endif
					<div class="col-xs-6" style="margin-bottom: 20px; text-align: center;">
						<a href="/administrator/support/{{ $b->id }}/close" style="text-decoration:none;"><div class="btn-success">Close Ticket</div></a>
					</div>
				</div>
			</div>
	@endforeach
