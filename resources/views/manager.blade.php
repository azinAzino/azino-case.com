...
<head>
    ...
    <script src="{{asset('assets/admin/plugins/ion.rangeslider/js/ion.rangeSlider.min.js')}}" type="text/javascript">
    </script>
    ...
    <script src="{{asset('assets/admin/plugins/bootstrap-fileinput/bootstrap-fileinput.js')}}" type="text/javascript">
    </script>
            ...
            <div class="page-sidebar-wrapper">
                <div class="page-sidebar navbar-collapse collapse">
                    <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false"
                        data-auto-scroll="false" data-slide-speed="200" style="padding-top: 20px">
                        ...
                        <li class="nav-item  ">
                            <a href="/manager/users" class="nav-link nav-toggle">
                                <i class="icon-users"></i>
                                <span class="title">Пользователи</span>
                            </a>
                        </li>
                        <li class="nav-item  ">
                            <a href="/manager/payments" class="nav-link nav-toggle">
                                <i class="fa fa-database" aria-hidden="true"></i>
                                <span class="title">Последние пополнения</span>
                            </a>
                        </li>
                        <li class="nav-item  ">
                            <a href="/manager/withdraw" class="nav-link nav-toggle">
                                <i class="icon-star"></i>
