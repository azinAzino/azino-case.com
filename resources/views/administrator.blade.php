                ...
                <div class="page-sidebar navbar-collapse collapse">
                    <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="false" data-slide-speed="200" style="padding-top: 20px">
                        ...
                        <li class="nav-item start active open">
                            <a href="/administrator" class="nav-link nav-toggle">
                                <i class="icon-home"></i>
                        ...
                        <li class="nav-item  ">
                            <a href="/administrator/users" class="nav-link nav-toggle">
                                <i class="icon-users"></i>
                                <span class="title">Пользователи</span>
                            </a>
                        </li>
                        <li class="nav-item  ">
                            <a href="/administrator/payments" class="nav-link nav-toggle">
                                <i class="fa fa-database" aria-hidden="true"></i>
                                <span class="title">Последние пополнения</span>
                            </a>
                        </li>
                        <li class="nav-item  ">
                            <a href="/administrator/withdraw" class="nav-link nav-toggle">
                                <i class="icon-star"></i>
