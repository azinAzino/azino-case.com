...
<div class="">
	<button type="button" class="btn blue btn-sm" data-toggle="modal" data-target="#tickets_template"
		style="float:right;" href="/manager/tickets/templates/create">{{ trans('Create') }}</button>
						...
						<tr>
							...
							<td align="center" style="vertical-align: middle;">
								<button type="button" class="btn blue btn-sm" data-toggle="modal"
									...
									href="/manager/tickets/templates/{{ $template->id }}/edit">{{ trans('Edit') }}</button>
								<button type="button" class="btn red btn-sm" data-toggle="modal"
									data-target="#tickets_template"
									href="/manager/tickets/templates/{{ $template->id }}/delete">{{ trans('Delete') }}</button>
							</td>
						</tr>
						@endforeach
					</tbody>
