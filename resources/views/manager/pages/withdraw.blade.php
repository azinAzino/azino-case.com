					...
					<tbody>
						...
						<tr>
							...
							<td style="vertical-align: middle;"><a href="https://vk.com/{{ $withdrow->user->login }}"
									...
									data-target="#user_edit" href="/manager/user/{{ $withdrow->user->id }}/edit" style="display: inline-block;
							...
							<td style="vertical-align: middle;">@if(isset($withdrow->status) && isset($withdrow->id))
								@if($withdrow->status == 0)<a class="btn blue btn-sm" data-toggle="modal"
									...
									href="/manager/withdraw/{{ $withdrow->id }}/edit">Редактировать</a>@endif @endif</td>
						</tr>
						@endforeach
						@endif
					</tbody>
...
<div class="modal fade" id="usr_edit" tabindex="-1" role="basic" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			@if(isset($withdrow))
			@include('manager.includes.modal_withdrows', ['user' => $withdrow])
			@else
			@endif
		</div>
	</div>
...
<div class="modal fade" id="user_edit" tabindex="-1" role="basic" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			@include('manager.includes.modal_users', ['user' => $withdrow->user])
		</div>
	</div>
</div>
@endif
