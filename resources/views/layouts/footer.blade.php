        ...
        <div class="row">
            <div class="col-sm-5 col-md-3 col-lg-3 hidden-xs">
                <div class="footer__copyright-block">
                    ...
                    <div class="footer__mini-description text-block text-block_color_gray text-block_fs_m">{{ trans('Cases with money') }}!</div>
                    <div class="footer__terms text-block text-block_color_gray text-block_fs_m">{{ trans('Write to us') }}: <a href="email:info@azino-case.com"><span class="text-block__link">info@azino-case.com</span></a></div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                ...
                <div class="pay-system">
					...
					<div class="pay-system__img-wrapper"><img src="/img/system/pay-icon_bee.png" alt="Beeline" title="Beeline" class="pay-system__img"/></div> --}}
				</div>
            </div>
            <div class="col-xs-12 visible-xs">
                <div class="footer__copyright-block">
                    <div class="footer__copyright text-block text-block_fs_m">© 2017 &mdash; 2020</div>
                    <div class="footer__mini-description text-block text-block_color_gray text-block_fs_m">{{ trans('Cases with money!') }}</div>
                    <div class="footer__terms text-block text-block_color_gray text-block_fs_m">{{ trans('Write to us') }}: <a href="mailto:info@azino-case.com"><span class="text-block__link">info@azino-case.com</span></a></div>
                    <div class="footer__terms text-block text-block_color_gray text-block_fs_s">
                    {{ trans('By logging in you accept') }}
                        <a href="/terms" class="text-block__link">{{ trans('the terms of use') }}</a></div>
                    <div class="footer__age-limit-wrapper">
                        <div class="age-limit">18+</div>
                    </div>
                </div>
