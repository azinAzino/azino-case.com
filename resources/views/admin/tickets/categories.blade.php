...
<div class="">
	<button type="button" class="btn blue btn-sm" data-toggle="modal" data-target="#tickets_category"
		style="float:right;" href="/admin/tickets/categories/create">{{ trans('Create') }}</button>
						...
						<tr>
							...
							<td align="center" style="vertical-align: middle;">
								<button type="button" class="btn blue btn-sm" data-toggle="modal"
									...
									href="/admin/tickets/categories/{{ $category->id }}/edit">{{ trans('Edit') }}</button>
								<button type="button" class="btn red btn-sm" data-toggle="modal"
									data-target="#tickets_category"
									href="/admin/tickets/categories/{{ $category->id }}/delete">{{ trans('Delete') }}</button>
							</td>
						</tr>
						@endforeach
					</tbody>
