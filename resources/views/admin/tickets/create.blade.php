...
<div class="row">
    <div class="col-md-12">
        <div class="tik_reply">
            ...
            <form method="POST" enctype="multipart/form-data" action="/admin/tickets/answer">
...
<script>
    ...
    pattern.onchange = function () {
        $.ajax({
            url: "/admin/tickets/pattern/" + pattern.value,
    ...
    pattern_category.onchange = function () {
        $.ajax({
            type: "GET",
            url: "/admin/tickets/get_patterns/" + pattern_category.value,
            success: function (data, textStatus) {
