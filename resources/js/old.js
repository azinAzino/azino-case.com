            ...
            c = {
                ...
                lang: {
                    ru: {
                        ...
                        errorFatalText:
                            "Упс, что-то пошло не так. Мы уже разбираемся в чем причина и скоро все починим.",
                        errorAuthTitle: "Войдите в свой аккаунт",
                        errorAuthText:
                            "Для того чтобы открыть яйцо необходимо войти на сайт через ВК, Facebook или Одноклассники.",
                        errorAuthButton: "Войти",
                        errorBalanceTitle: "Недостачно средств",
                        errorBalanceText:
                            "К сожалению, на вашем счете недостаточно средств. Пополните баланс любым удобным способом.",
                        errorBalanceButton: "Пополнить баланс",
                        balanceAddTitle: "Пополнение баланса",
                        balanceAddText:
                            "Спасибо, оплата прошла успешно!<br>Баланс будет пополнен в течение нескольких минут!",
                        balanceFailTitle: "Пополнение баланса",
                        balanceFailText:
                            "Платеж отменен! Попробуйте пополнить баланс еще раз."
                    },
                    en: {
