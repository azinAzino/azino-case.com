    ...
    var handleTheme = function() {
        ...
        $.fn.dataTableExt.afnFiltering.push(function(
            ...
            if (typeof aData._date == "undefined") {
                aData._date = new Date(getDateFromFormat(aData[3])).getTime();
            }
        ...
        $("#datepicker_from")
            .datepicker({
                ...
                onSelect: function(date) {
                    ...
                    console.log(getDateFromFormat(date));
                    oTable.draw();
                }
            })
            .keyup(function() {
                minDateFilter = new Date(getDateFromFormat(this.value)).getTime();
                oTable.draw();
            });
        ...
        $("#datepicker_to")
            .datepicker({
                ...
                buttonImageOnly: false,
                onSelect: function(date) {
                    maxDateFilter = new Date(getDateFromFormat(date)).getTime() + 60 * 60 * 24 * 1000 - 1;
                    console.log(maxDateFilter);
                    oTable.draw();
                }
            })
            .keyup(function() {
                maxDateFilter = new Date(getDateFromFormat(this.value)).getTime() + 60 * 60 * 24 * 1000 - 1;
                console.log(maxDateFilter);
                oTable.draw();
            });
