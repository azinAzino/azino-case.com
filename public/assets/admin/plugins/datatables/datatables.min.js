...
sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"Первая",sLast:"Последняя",sNext:"Вперед",sPrevious:"Назад"},sEmptyTable:"Нет данных",sInfo:"Показано от _START_ до _END_ из _TOTAL_ записей",sInfoEmpty:"Показано от 0 до 0 из 0 записей",sInfoFiltered:"(отфильтровано из _MAX_ записей)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Show _MENU_ entries",sLoadingRecords:"Загрузка...",sProcessing:"Выполнение...",sSearch:"Поиск:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Запись не найдена"},
